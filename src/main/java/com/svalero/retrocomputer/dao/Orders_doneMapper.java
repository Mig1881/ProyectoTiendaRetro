...
public class Orders_doneMapper implements RowMapper<Orders_done> {
    ...
    //quitar la referencia a un posible usuario que nos hagamos cargado, esto en el mundo real es poco probable, cargarte usuarios,
    //pero en el proyecto que estamos haciendo, esta dentro de un DAO y hay que Eliminar como requisito del proyecto.
